  ...
  return (
    <>
      <div className='preFooter'>
        ...
        <div>
          {shieldIcon}
          <p><b>100% secure payments</b> <br />We supports cards, wallets, EMI and COD</p>
        </div>
        <div>
          {mapIcon}
          <p><b>Vast service networks</b> <br />1000 Mi services-centers across 600 countries</p>
        </div>
      </div>

      <div className='preFooter2'>
        <div><p>LET'S STAY IN TOUCH</p> <span>Get updated on sales specials and more</span></div>
        ...
        <div>
          ...
          <span>Thanks, You're on our mail list for special offers.</span>
        </div>
